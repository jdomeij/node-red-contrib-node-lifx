 ...
 */
LightServer.prototype.newLight = function newLight(info, callback) {
  var self = this;
  ...
  light.initialize((err) => {
    ...
    light.on('change', () => {
      self.statusUpdateLight(light, 'change');
    });

    light.on('updated', () => {
      self.statusUpdateLight(light, 'updated');
    })
    ...
    self.statusUpdateLight(light, 'new');
 ...
 */
LightServer.prototype.statusUpdateLight = function statusUpdateLight(light, event) {
  var self = this;
